...
RECpath=$BASEpath'/cam1'
COPYpath='/home/pi/google_drive'

openRTSP -D 1 -B 10000000 -b 10000000 -4 -d 60 rtsp://10.0.0.204:554/user=admin_password=tlJwpbo6_channel=1_stream=0.sdp?real_stream  >  $RECpath/$name.avi
